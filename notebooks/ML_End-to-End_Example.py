...
white_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/gabor_rabai@epam.com/winequality_white.csv", sep=';')
red_wine = pd.read_csv("/dbfs/FileStore/shared_uploads/gabor_rabai@epam.com/winequality_red.csv", sep=';')
...
with mlflow.start_run(run_name='xgboost_models'):
  best_params = fmin(
    ...
    max_evals=96,
    trials=spark_trials, 
    rstate=np.random.default_rng(123) #changed np.random.mtrand.RandomState(123) 
  )
...
table_path = "dbfs:/gabor_rabai@epam.com/delta/wine_data"
...
import os
os.environ["DATABRICKS_TOKEN"] = "dapi2d3b1d828e8a568b72677844a69977e8-2"
...
def score_model(dataset):
  url = 'https://adb-253176023124584.4.azuredatabricks.net/model/wine_quality/3/invocations'
